...
\centering
%\fbox{
\includegraphics[page=2,trim={70 345 60 360},clip,scale=1.0]{Figures/Figures.pdf}
%}
...
\caption{\bf 2m surface cover (bare earth, roads, grass, trees, water, and buildings), building footprints and heights, and tree cover locations and heights from Geoscape \citep{Geoscape2020}.}
 \label{fig:geoscape}
\end{figure*} 
...
\centering
%\fbox{
\includegraphics[page=1,trim={70 380 60 390},clip,scale=1.0]{Figures/Figures.pdf}
%}
...
\begin{figure*}
\centering
\includegraphics[page=2,trim={75 240 60 240},clip,scale=0.85]{../Presentation/PresentationImages.pdf}
...
The features for Melbourne were extracted from the Geoscape GIS layers \citep{Geoscape2020} which provide 
